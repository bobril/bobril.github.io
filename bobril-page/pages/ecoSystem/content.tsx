...
<h2 id="bobx"><a href="https://github.com/bobril/bobx">{`BobX`}</a></h2>
...
<h2 id="bobflux"><a href="https://github.com/karelsteinmetz/bobflux">{`Bobflux`}</a></h2>
...
<h2 id="bobrilstrap"><a href="https://github.com/keeema/bobrilstrap">{`Bobrilstrap`}</a></h2>
...
<h2 id="bobril-m"><a href="https://github.com/bobril/bobril-m">{`Bobril-M`}</a></h2>
<p><a href="https://badge.fury.io/js/bobril-m"><img src="https://badge.fury.io/js/bobril-m.svg" alt="npm version"/></a></p>
<p>{`Bobril Material UIs. `}<a href="http://bobril.com/bobril-m">{`Demo pages`}</a>{` | `}<a href="https://github.com/bobril/bobril-m">{`GitHub`}</a></p>
</>;