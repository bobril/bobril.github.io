                                        ...
                                        children: {
                                            ...
                                            component: {
                                                onClick: () => {
                                                    ...
                                                    var offsetTop =
                                                        e.offsetTop - 70; // Header compensation + 10px
                                                    window.scrollTo(
                                                        0,
                                                        offsetTop
                                                    );
                ...
                children: [
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            { tag: 'h3', children: ['Easy to generate'] },
                            {
                                tag: 'p',
                                children: [
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            {
                                tag: 'p',
                                children: ['There are 2 versions of framework.']
                            },
                            {
                                tag: 'p',
                                children: [
                                    'First should be used directly as scripts without any build tool, it declares global variable ',
                                    {
                                        tag: 'code',
                                        className: '',
                                        children: 'b'
                                    },
                                    ' which is like namespace for all Bobril methods. And is probably easiest way to start learning Bobril. '
                                ]
                            },
                            {
                                tag: 'p',
                                children: [
                                    'Second one in package directory which is published in NPM. It is meant to be used with ',
                                    { tag: 'b', children: ['bobril-build'] },
                                    '. And should be used with standard ',
                                    { tag: 'b', children: ['ES6 imports'] },
                                    '. For this version there is also additional NPM module ',
                                    { tag: 'b', children: ['bobril-g11n'] },
                            ...
                            },
                            {
                                ...
                                children: [
                                    ...
                                    ' variable which could be predefined to false and remove some code by uglify, also remove warnings for developer mistakes, so make sure you are using nonminified version in development.'
                                ]
                            }
                        ]
                    },
                    {
                        ...
                        children: [
                            ...
                            },
                            {
                                tag: 'p',
                                children: [
                                    'Creation of maintainable Bobril components is explained further in documentation - ',
                                    {
                                        tag: 'a',
                                        attrs: {
                                            href: '#menu-bobril-component',
                                            title: ''
                                        },
                                        children: ['Bobril Component']
                                    },
                                ...
                                children: [
                                    {
                                        tag: 'tr',
                                        children: [
                                            { tag: 'td', children: ['HTML'] },
                                            { tag: 'td', children: ['Bobril'] }
                                        ]
                                    },
                                    {
                                        tag: 'tr',
                                                ...
                                                children: [
                                                    {
                                                        ...
                                                        className: '',
                                                        children:
                                                            '{ tag:"a", attrs: { href:"url" }, children:"Ex" }'
                                                    }
                                                ]
                                            }
                                        ]
                                                ...
                                                children: [
                                                    {
                                                        ...
                                                        className: '',
                                                        children:
                                                            '<span style="text-size:20px">Big</span>'
                                                    }
                                                ]
                                            },
                                            {
                                                ...
                                                children: [
                                                    {
                                                        ...
                                                        className: '',
                                                        children:
                                                            '{ tag:"span", style: { textSize:"20px" }, children:"Big" }'
                                                    }
                                                ]
                                            }
                                        ]
                                                ...
                                                children: [
                                                    {
                                                        ...
                                                        className: '',
                                                        children:
                                                            '{ tag:"h1", className:"head", children:"<" }'
                                                    }
                                                ]
                                            }
                                        ]
                                                ...
                                                children: [
                                                    {
                                                        ...
                                                        className: '',
                                                        children:
                                                            '{ tag:"div", children: [ { tag:"span", children: "A" }, "B" ] }'
                                                    }
                                                ]
                                            }
                                        ]
                            ...
                            },
                            {
                                ...
                                children: [
                                    ...
                                    },
                                    {
                                        tag: 'li',
                                        children: [
                                            { tag: 'p', children: ['string'] }
                                        ]
                                    },
                                    {
                                        tag: 'li',
                                        children: [
                                            { tag: 'p', children: ['number'] }
                                        ]
                                    },
                                    {
                                        tag: 'li',
                                        children: [
                                            {
                                                tag: 'p',
                                                children: [
                                                    'object - Objects must contain at least one of ',
                                                    {
                                                        tag: 'code',
                                                        className: '',
                                                        children: 'tag'
                            ...
                            },
                            {
                                ...
                                children: [
                                    ...
                                    ' are automatically skipped. Nested arrays are flattened. Strings, numbers are DOM text nodes.'
                                ]
                            },
                            {
                                tag: 'p',
                                children: [
                                    'Maybe you are asking why skipping ',
                                    {
                                        tag: 'code',
                                        className: '',
                                        children: 'false'
                                    ...
                                    ' is useful. It allows to write code like this:'
                                ]
                            },
                            {
                                tag: 'pre',
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            },
                            {
                                tag: 'p',
                                children: [
                                    'For a complete description of interfaces see: ',
                                    {
                                        tag: 'a',
                                        attrs: {
                                            href:
                                                'https://github.com/Bobris/Bobril/blob/master/dist/bobril.d.ts',
                                            title: ''
                                        },
                                        children: ['Bobril definition file']
                                    },
                                    '.'
                                ]
                            },
                            ...
                            },
                            {
                                tag: 'p',
                                children: [
                                    'There are 3 special values for ',
                                    {
                                        tag: 'code',
                                        className: '',
                                        children: 'tag'
                                        ...
                                        children: [
                                            {
                                                ...
                                                children: [
                                                    ...
                                                    ' - it means to skip update of this component. It could be used for very similar purposes as ',
                                                    {
                                                        tag: 'code',
                                                        className: '',
                                                        children: 'shouldChange'
                                                    },
                                                    ' lifecycle method.'
                                                ]
                                            }
                            ...
                            },
                            {
                                ...
                                children: [
                                    ...
                                    ', Bobril automatically adds all namespace crap, so your code is more readable.'
                                ]
                            },
                            { tag: 'h3', children: ['Attrs'] },
                            {
                                tag: 'p',
                                children: [
                                    {
                            ...
                            },
                            {
                                ...
                                children: [
                                    ...
                                    ' is reserved word in JS it must be written as ',
                                    {
                                        tag: 'code',
                                        className: '',
                                        children: 'htmlFor'
                            ...
                            },
                            {
                                ...
                                children: [
                                    ...
                                    ' is handled specially. It could be string or object. String case for ',
                                    {
                                        tag: 'code',
                                        className: '',
                                        children: 'style'
                                    },
                                    ' should be used very rarely, because it is not enriched like object case. '
                                ]
                            },
                            {
                                tag: 'p',
                                children: [
                                    ...
                                    ' because it is also reserved keyword.'
                                ]
                            },
                            { tag: 'h3', children: ['Children'] },
                            {
                                tag: 'p',
                                children: [
                                    {
                            ...
                            },
                            {
                                tag: 'p',
                                children: [
                                    'Every bobril node could have ',
                                    {
                                        tag: 'code',
                                        className: '',
                                        children: 'component'
                                    },
                                    ' field defined.  It can contain main lifecycle methods. \nIt can also contain event handlers. You should not use native HTML events directly, for example through ',
                                    {
                                        tag: 'code',
                                        className: '',
                                        children: 'attrs'
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            { tag: 'h4', children: ['b.init'] },
                            { tag: 'h4', children: ['b.addRoot'] },
                            { tag: 'h4', children: ['b.invalidate'] }
                        ]
                    },
                    {
                        tag: 'div',
                        children: [
                            ...
                            { tag: 'h3', children: ['Lifecycle'] },
                            { tag: 'h4', children: ['init'] },
                            { tag: 'h4', children: ['render'] },
                            { tag: 'h4', children: ['postRender'] },
                            { tag: 'h4', children: ['postInitDom'] },
                            { tag: 'h4', children: ['postUpdateDom'] },
                            { tag: 'h4', children: ['postUpdateDomEverytime'] },
                            { tag: 'h4', children: ['shouldChange'] },
                            { tag: 'h4', children: ['destroy'] },
                            { tag: 'h4', children: ['canActivate'] },
                            { tag: 'h4', children: ['canDeactivate'] },
                            { tag: 'h3', children: ['Component Creation'] },
                            { tag: 'h4', children: ['Context'] },
                            { tag: 'h4', children: ['IData Interface'] },
                            { tag: 'h4', children: ['createComponent'] },
                            {
                                tag: 'p',
                                children: [
                                    {
                                    ...
                                    ' is a base function for construct components. It accepts the ',
                                    {
                                        tag: 'code',
                                        className: '',
                                        children: 'IBobrilComponent'
                                    },
                                    ' object, which contains all lifecycle methods (',
                                    {
                                        tag: 'code',
                                        className: '',
                                        children: 'init'
                                    ...
                                    ', ',
                                    {
                                        tag: 'code',
                                        className: '',
                                        children: 'postInitDom'
                                    },
                                    ', etc.) and returns a function, which accepts typed data that are passed in ',
                                    {
                                        tag: 'code',
                                        className: '',
                                        children: 'IBobrilCtx'
                                    },
                                    ' to the defined lifecycle methods. Invocation of the created function will return ',
                                    {
                                        tag: 'a',
                                        attrs: {
                            ...
                            },
                            {
                                tag: 'p',
                                children: [
                                    'These lines of code simply results in the following. You can ',
                                    {
                                        tag: 'a',
                                        attrs: { href: '#style', title: '' },
                                        children: ['style']
                                    },
                                    ' the result.  '
                                ]
                            },
                            { tag: 'p', children: ['Animals'] },
                            {
                                tag: 'ul',
                                children: [
                                    {
                            ...
                            { tag: 'h4', children: ['createDerivedComponent'] },
                            {
                                tag: 'h4',
                                children: ['createOverridingComponent']
                            },
                            { tag: 'h4', children: ['createVirtualComponent'] }
                        ]
                    },
                    {
                        tag: 'div',
                        children: [
                            {
                                tag: '/',
                                children: "<h2 id='menu-events'>Events</h2>"
                            },
                            { tag: 'h3', children: ['Event basics'] },
                            {
                                tag: 'p',
                                children: [
                                    'Bobril application never works with native browser events directly. First native browser events listened only on body/document, then are processed, normalized by Bobril, and finally they just call methods on your component ',
                                    {
                                        tag: 'code',
                                        className: '',
                                        children: 'IBobrilComponent'
                                    },
                                    ' implementation. First simple example how to listen on any click:'
                                ]
                            },
                            {
                                tag: 'pre',
                            ...
                            {
                                tag: 'h3',
                                children: ['How to emit your own Bobril events']
                            },
                            {
                                tag: 'p',
                                children: [
                    ...
                    },
                    {
                        ...
                        children: [
                            {
                                tag: '/',
                                children: "<h2 id='menu-assets'>Assets</h2>"
                            },
                            { tag: 'h3', children: ['CSS Injection'] },
                            { tag: 'h4', children: ['b.injectCss'] },
                            { tag: 'h3', children: ['Loading Assets'] },
                            { tag: 'h4', children: ['b.asset'] },
                            { tag: 'h4', children: ['b.sprite'] }
                        ]
                    },
                    {
                        tag: 'div',
                        children: [
                            ...
                            { tag: 'h3', children: ['Media'] },
                            { tag: 'h4', children: ['IBobrilMedia'] },
                            { tag: 'h4', children: ['getMedia'] }
                        ]
                    },
                    {
                        tag: 'div',
